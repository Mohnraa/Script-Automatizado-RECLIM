	...
	:: DETECTAR SI EQUIPO ES ESCRITORIO O LAPTOP (EDIT wmic systemenclosure get chassistypes)
	:: REVISAR SI EL DISCO FUE EXPANDIDO
	:: AGREGAR PROGRAMAS DE DIAGNOSTICO Y TESTEO FINAL (CRYSTALDISK, FURMARK, AIDA64, DDU. )
